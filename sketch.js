...
var obstaclesGroup, obstacleImage, obstacle2;
...
survivor_collided = loadImage("survivor.png");
}
...
function setup(){
  createCanvas(windowWidth,windowHeight);  
    ...
    score =0
  //Moving background  
  bg=createSprite(200,200,200,800);  
  bg.addImage(bgImg); 
 ...
 //bg.addImage(bgImg2);
  ...
  survivor.addImage("collided", survivor_collided);
  survivor.scale =1.0;
  survivor.scale = 1.0;
...
if(coinsGroup.isTouching(survivor)){
  ...
  coinsGroup.destroyEach();
   ...
   //survivor_running.velocityX = 0;
   //changing the animation of the survivor
    survivor.changeImage("collided",survivor_collided);
   }
  drawSprites(); 
